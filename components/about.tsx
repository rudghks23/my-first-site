...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"단국대학교","period":"2022 - 현재","description":"부동산에 대한 전반적인 이론과 실습, 더 나은 도시 환경을 만들어가는 방법을 연구하고 있습니다. 미래의 부동산 전문가로서 다양한 프로젝트와 연구에 참여하며 깊이 있는 지식을 쌓아가고 있습니다."},{"icon":"award","title":"자격증","period":"자격증: 2025. 투자자산운용사","description":"전문적인 자산 운용에 대한 이해를 바탕으로, 투자 분석과 전략 수립을 위한 심화 학습을 진행 중입니다. 이 자격증을 통해 시장 변화에 빠르게 대응할 수 있는 능력을 키우고 있습니다."},{"icon":"lightbulb","title":"프로젝트 경험","period":"2022~현재","description":"부동산 투자 프로젝트 분석을 통해 리스크 분석, 수익성 평가 등을 미리 경험하며 실전 경험을 쌓고 있습니다. 또한, 도시 개발 관련 프로젝트에서 실제 개발과 운영 사례를 분석하고 이를 통해 실질적인 해결책을 제시하는 법을 배우고 있습니다."},{"icon":"user","title":"지속적 발전","period":"∞","description":"지속적으로 부동산 시장의 변화에 맞춰 학습하고 있으며 최신 트렌드를 반영하는 법을 배우고 있습니다. 제 커리어의 목표는 부동산 분야에서 인정받는 전문가로 성장하는 것이며, 이를 위해 실무와 이론을 균형 있게 발전시키고 있습니다."}],
    skills: [{"icon":"database","title":"백엔드 개발","description":"Node.js, Python, 데이터베이스 설계 및 구현을 통한 부동산 시장의 세밀한 분석 및 투자 전략 수립"},{"icon":"target","title":"부동산 투자 분석 및 전략 수립","description":"다양한 부동산 투자 프로젝트에서 수익성 분석, 리스크 평가 및 시장 동향 분석을 바탕으로 투자 전략을 수립하는 데 강점을 가지고 있습니다."},{"icon":"sparkles","title":"혁신적 사고와 기술적 접근","description":"부동산 및 도시계획 분야에서 최신 기술을 활용하여 보다 효율적이고 혁신적인 해결책을 제공하는 데 강점을 보유하고 있습니다."}],
    storyTitle: "나의 이야기",
    story: ["저는 작은 변화 속에서 의미를 발견하고, 그 가치를 실현하기 위해 움직이는 사람입니다.\n부동산과 도시의 흐름을 분석하며, 단순한 투자 이상의 지속 가능한 가치 창출을 추구합니다.\n\n꾸준함과 실행력을 가장 큰 강점으로 생각합니다. 한번 시작한 일은 끝까지 밀어붙이는 성격이며, 실제로 여러 프로젝트와 학부 활동에서 ‘완성도 높은 결과’를 만드는 데 집중해 왔습니다.","학생회 및 여러 팀 프로젝트 경험을 통해 문제를 정의하고 해결하는 과정의 재미를 배웠습니다.\n특히 부동산 경매 분석, 지역 개발 사례 연구, 데이터 기반 의사결정 프로젝트 등을 진행하며\n\n문제의 본질을 파악하는 분석력\n\n여러 이해관계자를 조율하는 협업 능력\n\n새로운 관점을 만드는 창의적 사고력\n\n을 키울 수 있었습니다.\n\n이 과정 속에서 저는 ‘한 사람의 노력이 팀의 성장을 만든다’는 사실을 깨달았고,\n그 이후로는 함께 성장하는 가치를 중요하게 생각하며 움직이고 있습니다.","앞으로 저는 시장을 바라보는 넓은 시야와, 데이터를 기반으로 한 전략적 접근력을 갖춰 도시와 사람을 잇는 가치를 만드는 전문가로 성장하는 것이 목표입니다. 변화는 두렵지 않습니다.\n저는 배움을 멈추지 않으며, 새로운 도전 속에서 더욱 단단한 사람으로 나아가겠습니다."],
    storyImage: "/uploads/about-image-1763624358685.png",
    hobbies: ["☕ 카페 투어","🎨 전시회 관람","✈️ 여행","🎬 영화 감상","🎮 게임"]
  }
