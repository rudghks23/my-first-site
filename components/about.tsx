...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"학교명","period":"2016 - 2020","description":"도시계획부동산학부"},{"icon":"award","title":"자격증/수상","period":"","description":""},{"icon":"heart","title":"열정","period":"2003-현재","description":"설명을 입력하세요"}],
